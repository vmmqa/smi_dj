...
def test():
    db = MysqlWrapper()
    '''
    db.insert_row('students', {"username": "1", "password": "z"})
    db.insert_row('students', {"username": "2", "password": "bx"})
    db.insert_row('students', {"username": "3", "password": "c"})
    db.insert_row('students', {"username": "4", "password": "d"})
    db.insert_row('students', {"username": "5", "password": "xxs"})
    db.insert_row('students', {"username": "6", "password": "x"})
    db.insert_row('students', {"username": "7", "password": "g"})
    db.insert_row('students', {"username": "8", "password": "n"})
    db.insert_row('students', {"username": "9", "password": "y"})
    db.insert_row('students', {"username": "10", "password": "o"})

    db.insert_row('students', {"username": "insertname", "password": "1111"})
    db.insert_row('students', {"username": "insertname", "password": "1111"})
    db.insert_row('students', {"username": "insertname", "password": "1111"})
    db.insert_row('students', {"username": "insertname", "password": "1111"})
    db.clear_rows('students', 'username','insertname1')
    db.clear_row_by_id('students', 8)
    db.clear_rows_by_ids('students', '7,8,9')
    db.clear_rows_by_dict('students',{'username':'insertname'})

    db.update_value('students', 'username','wm',{'name':'update_value'})
    db.update_value_by_id('students', 1,{'name':'update_value_by_id'})
    db.update_value_by_dict('students', {'username': 'wm','password': 'changed'},{'name': 'update_value_by_dict', 'is_super': 1})
    '''
    #print db.get_rows_by_dict('students', 0, 1, {'username':'wm','password':'changed'}, 'username,password',{'username':'desc','password':'asc'})
    #print db.get_rows_by_dict('students', 0, 5, {}, 'id',{'id':'desc','username':'asc','password':'asc'})
    print db.isunique_by_dict('students',{'username':1})
